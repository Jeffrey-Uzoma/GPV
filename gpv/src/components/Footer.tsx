          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {[
                {
                  label: 'Instagram',
                  href: 'https://www.instagram.com/goldenpremiumventures?igsh=MW8xM2xncTIxaXE5Mw==',
                  icon: (
                ...
                {
                  label: 'Facebook',
                  href: 'https://facebook.com/profile.php?id=61578665782123',
                  icon: (
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                {
                  label: 'TikTok',
                  href: 'https://www.tiktok.com/@golden.premium.ve?_r=1&_t=ZS-95iZYmAo5av',
                  icon: (
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:jeffreyzhxade@gmail.com" className="text-amber-400 hover:text-amber-200 text-sm transition-colors break-all">
                  jeffreyzhxade@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 text-amber-400 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
