...
const Checkout: React.FC = () => {
  ...
  // If order has been placed, show success message
  if (orderPlaced) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-gradient-to-r from-amber-950 to-amber-800 pt-24 pb-10 px-4">
          <div className="max-w-2xl mx-auto">
            <p className="text-amber-400 text-xs font-bold uppercase tracking-widest mb-2">Thank You</p>
            <h1 className="text-3xl md:text-4xl font-bold text-white">Order Placed Successfully!</h1>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Payment Receipt Sent!</h2>
            <p className="text-gray-600 mb-6">
              Your order details and payment receipt have been sent to our WhatsApp business line. 
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-100 mb-6">
              <p className="text-sm text-amber-800">
                <span className="font-semibold">Order Total:</span> ₦{total.toLocaleString()}
              </p>
              <p className="text-sm text-amber-800 mt-1">
                <span className="font-semibold">WhatsApp:</span> {BUSINESS_WHATSAPP}
              </p>
            </div>
